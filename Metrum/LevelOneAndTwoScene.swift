...
class LevelOneAndTwoScene: SKScene {
    // UI variables
...
extension LevelOneAndTwoScene: AccentuationInfoDelegate, ReplyIsCorrectDelegate, ReplyIsFalseDelegate, CongratulationsDelegate, WarningDelegate {
